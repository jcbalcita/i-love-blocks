	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function addBossBlock() {
	      this.blocks.push(new _block2.default({ count: 1000, pos: [50, -400], size: 400, vel: [0, 0.4], game: this }));
	    }
	  }, {
	    key: 'addBlock',
	...
	var GameView = function () {
	  ...
	  _createClass(GameView, [{
	    ...
	    value: function intro() {
	      ...
	      var drawBlocks = function drawBlocks() {
	        _this2.game.backgroundBlocks(_this2.ctx);
	      };
